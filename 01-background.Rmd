...
Thus a growth model curve is an example of a multilevel linear model with random coefficients [@Steele2007] and can be fitted using standard software, such as the R package **lme4** [@R-lme4].
